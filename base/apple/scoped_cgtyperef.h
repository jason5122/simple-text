...
struct ScopedTypeRefTraits<CGColorSpaceRef> {
    ...
    static CGColorSpaceRef Retain(CGColorSpaceRef object) {
        return CGColorSpaceRetain(object);
    }
    static void Release(CGColorSpaceRef object) {
        CGColorSpaceRelease(object);
    }
};
...
struct ScopedTypeRefTraits<CGContextRef> {
    ...
    static CGContextRef Retain(CGContextRef object) {
        return CGContextRetain(object);
    }
    static void Release(CGContextRef object) {
        CGContextRelease(object);
    }
};
