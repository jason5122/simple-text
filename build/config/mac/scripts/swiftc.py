...
def compile_module(module, sources, settings, extras, tmpdir):
    ...
    output_file_map.setdefault('', {})['swift-dependencies'] = os.path.join(
        tmpdir, module + '.swift.d'
    )
    ...
    module_cache_path = os.path.join(tmpdir, settings.swiftc_version, 'ModuleCache')
...
def main(args):
    ...
    parser.add_argument(
        '-whole-module-optimization', action='store_true', help='enable whole module optimization'
    )
    parser.add_argument('-object-dir', help='path to the generated object files directory')
    parser.add_argument('-pch-output-dir', help='path to directory where .pch files are saved')
    ...
    parser.add_argument('-bridge-header', help='path to the Objective-C bridge header')
    parser.add_argument('-depfile', help='path to the generated depfile')
    parser.add_argument('-swift-version', help='version of Swift language to support')
    parser.add_argument(
        '-target', action='store', help='generate code for the given target <triple>'
    )
    parser.add_argument('-sdk', action='store', help='compile against sdk')
    parser.add_argument(
        '-F', dest='framework_dirs', action='append', help='add dir to framework search path'
    )
    parser.add_argument(
        '-Fsystem',
        '-iframework',
    ...
    parser.add_argument(
        '-fix-module-imports', action='store_true', help='enable hack to fix module imports'
    )
    parser.add_argument(
        '-swiftc-version', default='', action='store', help='version of swiftc compiler'
    )
    parser.add_argument('-xcode-version', default='', action='store', help='version of xcode')
