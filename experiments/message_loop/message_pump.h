...
#include "experiments/message_loop/message_pump_type.h"
...
public:
    ...
    public:
        ...
        [[nodiscard]] ScopedDoWorkItem BeginWorkItem() { return ScopedDoWorkItem(this); }
    ...
    virtual bool HandleNestedNativeLoopWithApplicationTasks(bool application_tasks_desired);
