...
px_key named_key_for_keycode(unsigned short code) {
    ...
    case kVKSpace:
        return PX_KEY_SPACE;
    case kVKBackspace:
        return PX_KEY_BACKSPACE;
    case kVKForwardDelete:
        return PX_KEY_DELETE;
    case kVKEscape:
        return PX_KEY_ESCAPE;
    case kVKHelp:
        return PX_KEY_INSERT;
    case kVKHome:
        return PX_KEY_HOME;
    case kVKEnd:
        return PX_KEY_END;
    case kVKPageUp:
        return PX_KEY_PAGE_UP;
    case kVKPageDown:
        return PX_KEY_PAGE_DOWN;
    case kVKLeftArrow:
        return PX_KEY_LEFT;
    case kVKRightArrow:
        return PX_KEY_RIGHT;
...
bool is_private_use(unichar c) { return c >= 0xE000 && c <= 0xF8FF; }
