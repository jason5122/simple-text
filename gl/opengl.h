...
// Types. The sized ones stand in for the khronos_* types that <KHR/khrplatform.h>
// would supply; the stdint spellings below have the same width and signedness on
