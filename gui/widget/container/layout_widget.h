...
public:
    ...
    void add_child_start(std::unique_ptr<Widget> widget);
    void add_child_end(std::unique_ptr<Widget> widget);
    ...
    constexpr std::string_view class_name() const override { return "ContainerWidget"; }
