...
public:
    ...
    virtual px_cursor_t calculate_cursor(vec2 pos) { return PX_CURSOR_ARROW; }

    virtual bool drag_drop_enter(vec2 pos, const char* const* paths, int count) { return false; }
    virtual bool drag_drop_motion(vec2 pos, const char* const* paths, int count) { return false; }
    virtual void drag_drop_exit() {}
    virtual bool drag_drop_accept(vec2 pos, const char* const* paths, int count) { return false; }
