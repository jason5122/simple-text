...
//     // glUniform2f(glGetUniformLocation(shader_program.id, "resolution"), size.width,
//     size.height);
//     // glUniform2f(glGetUniformLocation(shader_program.id, "scroll_offset"), scroll.x,
//     scroll.y);
...
//     //     float vertical_scroll_bar_position_percentage = scroll.y / (line_count *
//     line_height);
//     //     instances.emplace_back(InstanceData{
//     //         .coords =
//     //             Vec2{
...
//     //     .rect_size = Vec2{static_cast<float>(size.width),
//     static_cast<float>(editor_offset.y)},
//     //     .color = Rgba::fromRgb(color_scheme.tab_bar, 255),
//     // });

//     // float tab_height = editor_offset.y - 5;  // Leave padding between window title bar and
//     tab.
...
//     // // Add side bar.
//     // instances.emplace_back(InstanceData{
//     //     .coords = {static_cast<float>(-editor_offset.x),
//     static_cast<float>(-editor_offset.y)},
