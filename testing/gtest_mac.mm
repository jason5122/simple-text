...
GTEST_API_ AssertionResult CmpHelperNSEQ(const char* expected_expression,
    ...
    return EqFailure(expected_expression, actual_expression, StringDescription(expected),
                     StringDescription(actual), false);
}
...
GTEST_API_ AssertionResult CmpHelperNSNE(const char* expected_expression,
    ...
    msg << "Expected: (" << expected_expression << ") != (" << actual_expression
        << "), actual: " << StringDescription(expected) << " vs " << StringDescription(actual);
...
GTEST_API_ AssertionResult CmpHelperNSNE(const char* expected_expression,
    ...
    Message msg;
    msg << "Expected: (" << expected_expression << ") != (" << actual_expression
        << "), actual: " << StringFromNSString(NSStringFromRect(expected)) << " vs "
        << StringFromNSString(NSStringFromRect(actual));
    return AssertionFailure(msg);
}
...
GTEST_API_ AssertionResult CmpHelperNSNE(const char* expected_expression,
    ...
    Message msg;
    msg << "Expected: (" << expected_expression << ") != (" << actual_expression
        << "), actual: " << StringFromNSString(NSStringFromPoint(expected)) << " vs "
        << StringFromNSString(NSStringFromPoint(actual));
    return AssertionFailure(msg);
}
...
GTEST_API_ AssertionResult CmpHelperNSNE(const char* expected_expression,
    ...
    Message msg;
    msg << "Expected: (" << expected_expression << ") != (" << actual_expression
        << "), actual: " << StringFromNSString(NSStringFromRange(expected)) << " vs "
        << StringFromNSString(NSStringFromRange(actual));
    return AssertionFailure(msg);
}
