...
void MainWidget::initShaders() {
    ...
    if (!program.addShaderFromSourceCode(QOpenGLShader::Vertex, vert_source_c)) close();

    // Compile fragment shader
    if (!program.addShaderFromSourceCode(QOpenGLShader::Fragment, frag_source_c)) close();
...
void MainWidget::initTextures() {
    ...
    texture = new QOpenGLTexture(QImage(cube_path.c_str()).mirrored());
