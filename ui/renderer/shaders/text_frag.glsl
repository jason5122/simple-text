...
void main() {
    if (rendering_pass == 0) {
        ...
        //     float border_left = bg_center.x - bg_size.x / 2 + tab_corner_radius +
        //     border_thickness; float border_right =
        //         bg_center.x + bg_size.x / 2 - tab_corner_radius - border_thickness;
